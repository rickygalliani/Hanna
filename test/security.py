...
class SecurityTest(unittest.TestCase):
    ...
    def test_inequality(self):
        sec1: Security = Security("sec", "SEC")
        sec2: Security = Security("sec", "SEC", name="sec_name", price=100.0)
        self.assertNotEqual(sec1, sec2)

    def test_equality(self):
        sec1: Security = Security("sec", "SEC", name="sec_name", price=100.0)
        sec2: Security = Security("sec", "SEC", name="sec_name", price=100.0)
