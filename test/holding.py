...
class HoldingTest(unittest.TestCase):
    def test_inequality(self):
        ...
        h2: Holding = Holding(sec2, 2, 20.0)
    ...
    def test_add_security_mismatch_holding(self):
        ...
        hol: Holding = Holding(sec1, 3, 30.0)
        other_hol: Holding = Holding(sec2, 1, 15.0)
        self.assertRaises(Exception, hol.add, other_hol)

    def test_add_normal(self):
        h: Holding = Holding("sec", 1, 100.0)
        other_holding: Holding = Holding("sec", 2, 202.0)
        h.add(other_holding)
